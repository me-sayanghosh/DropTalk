...
import React, { useState, Children, useRef, useEffect, ReactNode } from 'react';
import { motion, AnimatePresence } from 'framer-motion';

interface RenderStepIndicatorParams {
  step: number;
  currentStep: number;
...
function StepContentWrapper({
  ...
  const [parentHeight, setParentHeight] = useState<number | string>(0);
